...
use crate::state::{
    tick::*, tick_builder::TickBuilder, yevepool_builder::YevepoolBuilder, TickArray, Yevepool,
};
use crate::state::{YevepoolRewardInfo, NUM_REWARDS};
...
pub fn assert_swap(swap_update: &PostSwapUpdate, expect: &SwapTestExpectation) {
    ...
    assert_eq!(
        YevepoolRewardInfo::to_reward_growths(&swap_update.next_reward_infos),
